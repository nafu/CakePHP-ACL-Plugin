function init_register_user_controller(app_root_url, user_id, plugin, controller, missing_aco_text){
	//var url = app_root_url + "admin/admin_users/get_user_controller_permission/" + role_id + "/plugin:" + plugin + "/controller:" + controller;
	var url = app_root_url + "admin/admin_users/get_user_controller_permission/" + "?user_id=" + user_id + "&plugin=" + plugin + "&controller=" + controller;
...
function init_register_role_controller(app_root_url, role_id, plugin, controller, missing_aco_text){
	//var url = app_root_url + "admin/admin_users/get_role_controller_permission/" + role_id + "/plugin:" + plugin + "/controller:" + controller;
	var url = app_root_url + "admin/admin_users/get_role_controller_permission/" + "?role_id=" + role_id + "&plugin=" + plugin + "&controller=" + controller;
...
function register_role(start_granted, app_root_url, span_id, role_id, plugin, controller, action){
	if (start_granted) {
		//var url = app_root_url + "admin/admin_users/get_role_controller_permission/" + "?role_id=" + role_id + "&plugin=" + plugin + "&controller=" + controller;
		var url1 = app_root_url + "admin/admin_users/deny_role_permission/" + "?role_id=" + role_id + "&plugin=" + plugin + "&controller=" + controller + "&action=" + action;
		var url2 = app_root_url + "admin/admin_users/grant_role_permission/" + "?role_id=" + role_id + "&plugin=" + plugin + "&controller=" + controller + "&action=" + action;
	} else {
		var url1 = app_root_url + "admin/admin_users/grant_role_permission/" + "?role_id=" + role_id + "&plugin=" + plugin + "&controller=" + controller + "&action=" + action;
		var url2 = app_root_url + "admin/admin_users/deny_role_permission/" + "?role_id=" + role_id + "&plugin=" + plugin + "&controller=" + controller + "&action=" + action;
	}
